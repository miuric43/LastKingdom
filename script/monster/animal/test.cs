...
{
    public class 성기사 : Monster
    {
        public override string Name { get { return "성기사"+"   "; } }
        ...
        public override LootPack Loot
        {
            get
            {
                ...
                {
                    new LootPackEntry(100.0, typeof(script.item.AmityPlate), "15d10+225", 1,5,10),
        ...
        public 성기사(Serial temps, int x, int y, string map)
            : this(temps)
        {
            m_MonsterID = 228;
