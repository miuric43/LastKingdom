...
{
    public class 성장의상자 : BasePotion
    {
        public override string Name { get { return "성장의상자"+"     "; } }
        ...
        public override void Use(Player player)
        {
            if (Quantity >= 12 && player.GetFreeSlots() > 2)
              {
                  var newitem = new script.item.성장의시약().Inventory(player);
            ...
            else if (Quantity >= 3 && Quantity <= 11)
            {
                ...
                string itdrop = "성장의시약이" + (Quantity - 1) + "개남았습니다" + "                                          ";
