...
{
    public class ForceAmulet : BaseArmor
    {
        public override string Name { get { return "FORCE AMULET"; } }
        ...
        public override int StrBonus { get { return 21; } }
        ...
        public ForceAmulet(Serial serial)
            : base(serial)
        {
        }
    }
