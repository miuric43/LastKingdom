...
{
    public class 건물4 : BaseNPC
    {
        public override string Name { get { return "건물4"; } }
        public override string Map { get { return "튜토리얼"; } }
       // public override string ChatString { get { return "운영자존 : 어서오시게." + "                                       "; } }
        public override int ID { get { return (int)LKCamelot.library.NPCs.건물4; } }
        public override int X { get { return 6; } }
        public override int Y { get { return 13; } }
