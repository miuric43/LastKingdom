...
namespace LKCamelot.model
{
    public sealed class SetProfessions : Packet
    {
        public SetProfessions(string text)
            : base(0x41)
        {
            m_Stream.Write((short)text.Length);
            m_Stream.WriteUTF8Null(text);
        }
    }
    public sealed class AutoMove : Packet//이거 같은데 사용법 모름
    {
    ...
    public sealed class AddItemToInventory2 : Packet
    {
            ...
            : base(0x17)
        {
            ...
            m_Stream.WriteUTF8Null(item.ParsedStats);
        }
    }
    ...
    public sealed class PointChange : Packet
    {
        public PointChange(ulong amount)
            : base(0x41)
        {
            m_Stream.Write(amount > int.MaxValue ? int.MaxValue : Convert.ToInt32(amount));
        }
    }
    public sealed class TunChange : Packet
    {
        public TunChange(ulong amount)
            : base(0x42)
        {
            m_Stream.Write(amount > int.MaxValue ? int.MaxValue : Convert.ToInt32(amount));
        }
    }
    public sealed class BankChange : Packet
    {
        public BankChange(ulong amount)
            : base(0x71)
        {
            m_Stream.Write(amount > int.MaxValue ? int.MaxValue : Convert.ToInt32(amount));
        }
    }
    public sealed class PvPPointChange : Packet
    {
        public PvPPointChange(int amount)
            : base(0x72)
        {
            m_Stream.Write(amount > int.MaxValue ? int.MaxValue : Convert.ToInt32(amount));
        }
    }
    /*public sealed class BdayChange : Packet
    {
        public BdayChange(ulong amount)
            : base(0x43)
        {
            m_Stream.Write(amount > int.MaxValue ? int.MaxValue : Convert.ToInt32(amount));
        }
    ...
    public sealed class CreateMonster : Packet
    {
            ...
            : base(0x1D)
        {
            ...
            m_Stream.WriteUTF8Null("   "+item.Name + "   ");
        }
    }
    ...
    public sealed class CreateChar : Packet
    {
            ...
            : base(0x1D)
        {
            ...
            m_Stream.WriteUTF8Null("        " + play.Name + "        ");
        }
    }
    ...
    public sealed class BubbleChat : Packet
    {
            ...
            : base(0x20)
        {
            ...
            m_Stream.Write((byte)0);
            m_Stream.Write((short)m_Stream.GetStringLength(text));
            m_Stream.WriteUTF8Null(text);
        }
    }
    public sealed class SpawnShopGump2 : Packet
    {
            ...
            : base(0x3E)
        {
            ...
            m_Stream.WriteUTF8Null(shop.ItemNameString);
        }
    }
    ...
    public sealed class SetObjectEffectsPlayer : Packet
    {
            ...
            : base(0x34)
        {
            ...
            if (play.m_Buffs.Where(xe => xe.Name == "MENTAL SWORD" || xe.Name == "GOD BLADE").FirstOrDefault() != null)
