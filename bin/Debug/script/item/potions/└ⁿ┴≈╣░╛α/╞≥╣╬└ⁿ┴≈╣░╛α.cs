...
{
    public class 평민물약 : BasePotion
    {
        public override string Name { get { return "평민전직물약"+"      "; } }
        ...
        public override void Use(Player player)
        {
            if (Quantity >= 12)
            {
                ...
                player.Class = LKCamelot.library.Class.Beginner;
                string text2 = "아론=> 너는 이제 평민이 되었다" + "                       ";
            ...
            else if (Quantity >= 3 && Quantity <= 11)
            {
                ...
                string itdrop = "평민전직물약이" + (Quantity - 1) + "개남았습니다" + "                                          ";
