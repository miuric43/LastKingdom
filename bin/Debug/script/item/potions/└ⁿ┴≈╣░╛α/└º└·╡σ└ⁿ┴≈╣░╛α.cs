...
{
    public class 위저드물약 : BasePotion
    {
        public override string Name { get { return "위저드전직물약"+"      "; } }
        ...
        public override void Use(Player player)
        {
            if (Quantity >= 12)
            {
                ...
                string text2 = "아론=> 너는 이제 위저드가 되었다" + "                       ";
            ...
            else if (Quantity >= 3 && Quantity <= 11)
            {
                ...
                string itdrop = "위저드전직물약이" + (Quantity - 1) + "개남았습니다" + "                                          ";
