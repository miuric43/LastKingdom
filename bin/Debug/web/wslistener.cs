...
namespace LKCamelot
{
    public class WebSocketListener
    {
        ...
        public void run()
        {
            ...
            var server = new WebSocketServer("ws://14.43.117.241:43332/webtrader"); //use port 80 later + load config file
            try
            {
                server.Start(socket =>
                {
            ...
            Console.WriteLine(string.Format("서버로딩완료 {0}:{1}...", "0.0.0.0", "8181"), ConsoleColor.Green);
        }
    }
}
