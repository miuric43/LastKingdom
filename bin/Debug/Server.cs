...
namespace LKCamelot
{
       ...
       public class Server
        ...
        public static 제어창 frm;
        
#endif


        public static Stopwatch tickcount;
        public static int Exp_Ratio = 1;

        //퀴즈관련
        public static long quiz_time = 0; //퀴즈시간
        public static long quiz_time_temp = 0; //퀴즈시간
        public static Boolean quiz_start = false; // 퀴즈 시작설정
        public static string quiz_q = ""; //퀴즈문제
        public static string quiz_a = ""; //퀴즈정답
        public static ulong quiz_p = 0; //퀴즈상품
        //공성
        public static string Castellan = "";
        ...
        [STAThread]
            ...
            static void InitRoutine()
            {
                ...
                Console.WriteLine(Config.ServerName + "를 불러오는 중입니다 ");
        ...
        public void OnConnecte(object sender, ConnectionEventArgs e)
        {
            ...
            Console.WriteLine("연결된PC : " + Connections.Count + "개");
        ...
        public void OnDisconnecte(object sender, ConnectionEventArgs e)
        {
            ...
            Console.WriteLine("연결종료된PC : " + Connections.Count + "개");
        ...
        public void run()
        {
            ...
            Console.WriteLine("서버로딩중 {0}:{1}...", bindIP, Port);
        ...
        private void acceptCallback(IAsyncResult result)
        {
            ...
            try
            {
                ...
                Console.WriteLine("연결된 IP: "+socket.RemoteEndPoint);
            }
