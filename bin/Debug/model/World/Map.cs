...
namespace LKCamelot.model
{
    ...
    public static class Map
    {
        ...
        public static Dictionary<string, Point2D> mapsizes = new Dictionary<string, Point2D>()
        {
           ...
           { "ebox2x2.map", new Point2D(20,20)},
           { "ebox4x4.map", new Point2D(40,40)},
           { "GMMAP1.map", new Point2D(40,40)},
           { "ox3.map", new Point2D(200,200)},
           { "OxLv4.map", new Point2D(100,100)},
           ...
           { "m2miner1.map", new Point2D(100,100)},
